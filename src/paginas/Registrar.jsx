  ...
  return (
    <>
      ...
      <form action="" className="my-10 bg-white shadow rounded-lg p-10" onSubmit={handleSubmit}>
        <div className="my-5">
          <label className="uppercase text-gray-600 block tex-xl font-bold" htmlFor="nombre">
            Nombre
          </label>
          <input
            id="nombre"
        ...
        <div className="my-5">
          <label className="uppercase text-gray-600 block tex-xl font-bold" htmlFor="email">
            Email
          </label>
          <input
            id="email"
        ...
        <div className="my-5">
          <label className="uppercase text-gray-600 block tex-xl font-bold" htmlFor="password2">
            Repetir Password
          </label>
          <input
            id="password2"
